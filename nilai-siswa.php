            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="alert alert-info alert-dismissible fade show">
                        ...
                        <?php endwhile; ?>
                        <a href="nilai-siswa.php" class="float-right text-danger"><small>Hapus filter</small></a>
                    ...
                    <div class="active-filters">
                        ...
                        <a href="nilai-siswa.php" class="btn btn-sm btn-outline-secondary">
                    ...
                    showAlert('added', 'Data nilai siswa berhasil ditambah!');
                    showAlert('updated', 'Data nilai siswa berhasil diupdate!');
                    showAlert('deleted', 'Data nilai siswa berhasil dihapus!');
                    ?>
                    ...
                    <div class="card shadow">
                        <div class="card-body text-center py-5">
                            ...
                            <?php if ($filterMapel != '' || $filterKelas != ''): ?>
                            <a href="nilai-siswa.php" class="btn btn-primary">
                                <i class="fas fa-redo"></i> Tampilkan Semua Data
                            </a>
                            <?php else: ?>
                            <a href="tambah-nilai-siswa.php" class="btn btn-primary">
