...
// Ambil id_kelas dari nama kelas XII-A
$queryKelas = mysqli_query($koneksi, "SELECT id_kelas FROM kelas WHERE nama_kelas = 'XII-A'");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    showAlert('added', 'Data SPP kelas XII-A berhasil ditambah!');
                    showAlert('updated', 'Data SPP kelas XII-A diupdate!');
                    showAlert('deleted', 'Data SPP kelas XII-A dihapus!');
                    ?>
