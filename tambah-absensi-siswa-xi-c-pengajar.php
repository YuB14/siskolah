...
<head>
    ...
    <title>Siskolah - Tambah Absensi Siswa XI-C</title>
               ...
               <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <!-- Judul Halaman -->
                        <h1 class="h3 text-gray-800 mb-0">Tambah Absensi Siswa XI-C</h1>
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="proses-tambah-absensi-siswa-xi-c-pengajar.php" method="POST">
                            <div class="card-body">
                                <div class="row">
