...
$id_jadwal = 'JDWLXA' . str_pad($num, 4, '0', STR_PAD_LEFT);
?>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <!-- Judul Halaman -->
                        <h1 class="h3 text-gray-800 mb-0">Tambah Jadwal Mapel X-A</h1>

                        <!-- Breadcrumb -->
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                            <li class="breadcrumb-item active"><a href="jadwal-mata-pelajaran-x-a.php">Data Jadwal Mapel X-A</a></li>
                            <li class="breadcrumb-item active">Tambah Jadwal Mapel X-A</li>
                        </ol>
                    </div>
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="proses-tambah-jadwal-mata-pelajaran-x-a.php" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
