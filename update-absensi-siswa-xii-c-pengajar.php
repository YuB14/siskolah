...
");
    ...
    if (mysqli_num_rows($query) == 0) {
        echo "<script>alert('Data absensi tidak ditemukan!'); window.location='absensi-siswa-xii-c-pengajar.php';</script>";
        exit;
    }

    $data = mysqli_fetch_assoc($query);
} else {
    echo "<script>alert('ID absensi tidak ditemukan!'); window.location='absensi-siswa-xii-c-pengajar.php';</script>";
    exit;
}
?>
...
<head>
    ...
    <title>Siskolah - Update Absensi Siswa XII-C</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h1 class="h3 text-gray-800 mb-0">Update Absensi Siswa XII-C</h1>
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="proses-update-absensi-siswa-xii-c-pengajar.php" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
