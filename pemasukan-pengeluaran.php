                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <a href="tambah-data-pemasukan-pengeluaran.php" class="btn btn-sm btn-primary btn-icon-split mr-2">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="update-pemasukan-pengeluaran.php?id_keuangan=<?php echo $row['id_keuangan']; ?>" class="btn btn-sm btn-warning"><i class="fas fa-pencil-alt"></i></a>
                                            </td>
                                            <td class="text-center">
                                                <!-- Tombol Hapus-->
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a id="btnConfirmHapus" href="hapus-pemasukan-pengeluaran.php" class="btn btn-danger">Hapus</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
