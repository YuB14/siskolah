...
<head>
    ...
    <title>Siskolah - Update Siswa</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <!-- Judul Halaman -->
                        <h1 class="h3 text-gray-800 mb-0">Update Siswa</h1>

                        <!-- Breadcrumb -->
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="dashboard-admin.php">Home</a></li>
                            <li class="breadcrumb-item active"><a href="biodata-siswa-admin.php">Data Biodata Siswa</a></li>
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="proses-update-siswa-admin.php" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
