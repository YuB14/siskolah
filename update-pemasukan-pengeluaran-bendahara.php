...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $jumlah = str_replace(['.', ','], ['', '.'], $_POST['jumlah']); // format number
...
<head>
    ...
    <title>Siskolah - Update Pemasukan & Pengeluaran</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <!-- Judul Halaman -->
                        <h1 class="h3 text-gray-800 mb-0">Update Data Pemasukan & Pengeluaran</h1>

                        <!-- Breadcrumb -->
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="dashboard-bendahara.php">Home</a></li>
                            <li class="breadcrumb-item active"><a href="pemasukan-pengeluaran-bendahara.php">Data Pemasukan & Pengeluaran</a></li>
                            <li class="breadcrumb-item active">Update Data Pemasukan & Pengeluaran</li>
                        </ol>
                    </div>
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="proses-update-pemasukan-pengeluaran-bendahara.php" method="POST">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        name="id_keuangan"
                                        class="form-control"
                                        id="exampleInputIDKeuangan"
                                        placeholder="Masukkan ID Keuangan"
                                        required
                                        readonly
                                        value="<?php echo htmlspecialchars($data['id_keuangan']); ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="jumlah" class="form-control" id="jumlah" 
                                        value="<?php echo number_format($data['jumlah'], 0, ',', '.'); ?>" required>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="exampleSelectPenanggungJawab">Penanggung Jawab</label>
                                    <select class="custom-select form-control-sm"
                                            name="nip"
                                            id="exampleSelectPenanggungJawab"
                                            required>
                                        ...
                                        <?php
                                        // Ambil guru yang jabatannya Bendahara
