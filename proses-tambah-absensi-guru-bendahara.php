...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    header("Location: absensi-guru-bendahara.php");
    exit;
}
...
if (!$status || empty($nip_list)) {
    echo "<script>alert('Data tidak lengkap!'); window.location='absensi-guru-bendahara.php';</script>";
    exit;
}
...
header('Location: absensi-guru-bendahara.php?status=added');
exit;
