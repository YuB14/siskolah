                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6 text-right">
                                    <a href="tambah-guru-admin.php" class="btn btn-primary btn-icon-split">
                            ...
                            <div class="card teacher-card shadow border-left-primary">
                                ...
                                <div class="card-footer bg-white text-center py-2">
                                    ...
                                    <button class="btn btn-sm btn-danger" 
                                            data-toggle="modal" 
                                            data-target="#hapusModal<?= $row['nip'] ?>"
                                            title="Hapus Data">
                        ...
                        <div class="modal fade" id="hapusModal<?= $row['nip'] ?>" tabindex="-1" role="dialog" 
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <a href="hapus-guru-admin.php?nip=<?= $row['nip'] ?>" class="btn btn-danger">
