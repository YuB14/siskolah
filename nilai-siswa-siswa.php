...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="alert alert-info alert-dismissible fade show">
                        ...
                        <?php endwhile; ?>
                        <a href="nilai-siswa-siswa.php" class="float-right text-danger"><small>Hapus filter</small></a>
                    ...
                    <div class="active-filters">
                        ...
                        <a href="nilai-siswa-siswa.php" class="btn btn-sm btn-outline-secondary">
                    ...
                    <div class="card shadow">
                        <div class="card-body text-center py-5">
                            ...
                            <p class="text-muted">
                                ...
                                <?php else: ?>
                                    Belum ada data nilai siswa yang terdaftar untuk anda
                                <?php endif; ?>
                            </p>
                            <?php if ($filterMapel != '' || $filterKelas != ''): ?>
                            <a href="nilai-siswa-siswa.php" class="btn btn-primary">
    ...
    document.getElementById('btnResetFilter').addEventListener('click', function() {
        window.location.href = "nilai-siswa-siswa.php";
    });
