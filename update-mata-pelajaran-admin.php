...
// Ambil semua guru untuk dropdown pengajar
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update ke database
    $updateSQL = "UPDATE mata_pelajaran SET 
...
<head>
    ...
    <title>Siskolah - Update Mata Pelajaran</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <!-- Judul Halaman -->
                        <h1 class="h3 text-gray-800 mb-0">Update Data Mata Pelajaran</h1>
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="proses-update-mata-pelajaran-admin.php" method="POST">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        name="id_mapel"
                                        class="form-control"
                                        id="exampleInputIDMapel"
                                        placeholder="Masukkan ID Mapel"
                                        required
                                        readonly
                                        value="<?php echo htmlspecialchars($data['id_mapel']); ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="exampleSelectPengajar">Pengajar Mapel</label>
                                    <select class="custom-select form-control-sm"
                                            name="nip"
                                            id="exampleSelectPengajar"
                                            required>
