...
$query = mysqli_query($koneksi, "SELECT id_kelas FROM kelas ORDER BY id_kelas DESC LIMIT 1");
$row = mysqli_fetch_assoc($query);

if ($row) {
    // Ambil angka terakhir dari id terakhir
    $lastId = $row['id_kelas'];
    $num = (int) substr($lastId, 3); // asumsikan format ID: "KLS0001"
    $num++;
} else {
...
$id_kelas = 'KLS' . str_pad($num, 4, '0', STR_PAD_LEFT);
?>
...
<head>
    ...
    <title>Siskolah - Tambah Kelas</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="proses-tambah-kelas.php" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exampleInputIDKelas">ID Kelas</label>
                                    <input type="text" name="id_kelas" value="<?php echo $id_kelas; ?>" class="form-control" id="exampleInputIDKelas" readonly>
                                </div>
                                <div class="form-group">
