...
<head>
    ...
    <title>Siskolah - Tambah Guru Mapel</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <!-- Judul Halaman -->
                        <h1 class="h3 text-gray-800 mb-0">Tambah Guru Mapel</h1>

                        <!-- Breadcrumb -->
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                            <li class="breadcrumb-item active"><a href="guru-mapel.php">Guru Mapel</a></li>
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="proses-tambah-guru-mapel.php" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="Mapel">Mata Pelajaran</label>
                                    <select class="custom-select rounded-0" name="id_mapel" id="Mapel" required>
