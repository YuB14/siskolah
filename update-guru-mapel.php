...
// Cek apakah parameter id_mapel & nip dikirim
if (!isset($_GET['id_mapel']) || !isset($_GET['nip'])) {
...
// Ambil data guru-mapel yang ingin diupdate
$query = mysqli_query($koneksi, "
    SELECT gm.*, g.nama_lengkap, m.nama_mapel
    FROM guru_mapel gm
    LEFT JOIN guru g ON gm.nip = g.nip
    LEFT JOIN mata_pelajaran m ON gm.id_mapel = m.id_mapel
    WHERE gm.id_mapel = '$id_mapel' AND gm.nip = '$nip'
");

$data = mysqli_fetch_assoc($query);

// Ambil daftar guru & mapel untuk dropdown
...
<head>
    ...
    <title>Siskolah - Update Guru Mapel</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <!-- Judul Halaman -->
                        <h1 class="h3 text-gray-800 mb-0">Update Data Guru Mapel</h1>

                        <!-- Breadcrumb -->
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                            <li class="breadcrumb-item active"><a href="guru-mapel.php">Data Guru Mapel</a></li>
                            <li class="breadcrumb-item active">Update Data Guru Mapel</li>
                        </ol>
                    </div>
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="proses-update-guru-mapel.php" method="POST">
                            <!-- Hidden fields untuk primary key -->
                            <input type="hidden" name="id_mapel_lama" value="<?php echo $data['id_mapel']; ?>">
                            <input type="hidden" name="nip_lama" value="<?php echo $data['nip']; ?>">
                            <div class="form-group">
                                <label for="mapel">Mata Pelajaran</label>
                                <select class="form-control" name="id_mapel" id="mapel" required>
                                    <option value="">-- Pilih Mata Pelajaran --</option>
                                    <?php while($row = mysqli_fetch_assoc($queryMapel)) { ?>
                                        <option value="<?php echo $row['id_mapel']; ?>" <?php if($row['id_mapel'] == $data['id_mapel']) echo 'selected'; ?>>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="nip" id="guru" required>
                                    <option value="">-- Pilih Guru --</option>
                                    <?php while($row = mysqli_fetch_assoc($queryGuru)) { ?>
                                        <option value="<?php echo $row['nip']; ?>" <?php if($row['nip'] == $data['nip']) echo 'selected'; ?>>
                            ...
                            <a href="guru-mapel.php" class="btn btn-secondary">Batal</a>
                        </form>
                    </div>
                </div>
