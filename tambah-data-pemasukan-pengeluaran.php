    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                // ambil data kelas
                $queryPenanggungJawab = mysqli_query($koneksi, "SELECT nip, nama_lengkap FROM guru ORDER BY nama_lengkap ASC");
                ?>
                <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="proses-tambah-data-pemasukan-pengeluaran.php" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
