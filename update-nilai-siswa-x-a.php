...
// Ambil data dropdown
$siswaQuery  = mysqli_query($koneksi, "SELECT nisn, nama_lengkap FROM siswa ORDER BY nama_lengkap ASC");
...
<head>
    ...
    <title>Siskolah - Update Nilai Siswa X-A</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active">Update Data Nilai Siswa X-A</li>
                        </ol>
                    </div>
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="proses-update-nilai-siswa-x-a.php" method="POST">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        name="id_nilai"
                                        class="form-control"
                                        id="exampleInputIDNilai"
                                        placeholder="Masukkan ID Nilai"
                                        required
                                        readonly
                                        value="<?php echo htmlspecialchars($data['id_nilai']); ?>">
                                </div>

                                <div class="form-group">
                                    <label for="exampleSelectSiswa">Nama Siswa</label>
                                    <select class="custom-select form-control-sm"
                                            name="nisn"
                                            id="exampleSelectSiswa"
                                            required>
                                        <?php
                                        // Fetch semua siswa
                                        $querySiswa = mysqli_query($koneksi, "SELECT nisn, nama_lengkap FROM siswa ORDER BY nama_lengkap");
                                        while($siswa = mysqli_fetch_assoc($querySiswa)) {
                                            $selected = ($siswa['nisn'] == $data['nisn']) ? 'selected' : '';
                                            echo "<option value='{$siswa['nisn']}' $selected>{$siswa['nama_lengkap']}</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nilai_tugas_1" class="form-control" value="<?php echo intval ($data['nilai_tugas_1']); ?>">
                                </div>

                                <div class="form-group">
                                    <label>Nilai Tugas 2</label>
                                    <input type="text" name="nilai_tugas_2" class="form-control" value="<?php echo intval ($data['nilai_tugas_2']); ?>">
                                </div>

                                <div class="form-group">
                                    <label>Nilai Tugas 3</label>
                                    <input type="text" name="nilai_tugas_3" class="form-control" value="<?php echo intval ($data['nilai_tugas_3']); ?>">
                                </div>

                                <div class="form-group">
                                    <label>Nilai Tugas 4</label>
                                    <input type="text" name="nilai_tugas_4" class="form-control" value="<?php echo intval ($data['nilai_tugas_4']); ?>">
                                </div>

                                <div class="form-group">
                                    <label>Nilai Tugas 5</label>
                                    <input type="text" name="nilai_tugas_5" class="form-control" value="<?php echo intval ($data['nilai_tugas_5']); ?>">
                                </div>

                                <div class="form-group">
                                    <label>Nilai Tugas 6</label>
                                    <input type="text" name="nilai_tugas_6" class="form-control" value="<?php echo intval ($data['nilai_tugas_6']); ?>">
                                </div>

                                <div class="form-group">
                                    <label>Nilai Ulangan Harian 1</label>
                                    <input type="text" name="nilai_uh_1" class="form-control" value="<?php echo intval ($data['nilai_uh_1']); ?>">
                                </div>

                                <div class="form-group">
                                    <label>Nilai Ulangan Harian 2</label>
                                    <input type="text" name="nilai_uh_2" class="form-control" value="<?php echo intval($data['nilai_uh_2']); ?>">
                                </div>

                                <div class="form-group">
                                    <label>Nilai Ulangan Harian 3</label>
                                    <input type="text" name="nilai_uh_3" class="form-control" value="<?php echo intval ($data['nilai_uh_3']); ?>">
                                </div>

                                <div class="form-group">
                                    <label>Nilai UTS</label>
                                    <input type="text" name="nilai_uts" class="form-control" value="<?php echo intval ($data['nilai_uts']); ?>">
                                </div>

                                <div class="form-group">
                                    <label>Nilai UAS</label>
                                    <input type="text" name="nilai_uas" class="form-control" value="<?php echo intval ($data['nilai_uas']); ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tahun_ajaran" 
                                        ...
                                        value="<?php echo $data['tahun_ajaran']; ?>" required> 
                                </div>
