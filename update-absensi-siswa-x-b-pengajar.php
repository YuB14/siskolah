...
");
    ...
    if (mysqli_num_rows($query) == 0) {
        echo "<script>alert('Data absensi tidak ditemukan!'); window.location='absensi-siswa-x-b-pengajar.php';</script>";
        exit;
    }

    $data = mysqli_fetch_assoc($query);
} else {
    echo "<script>alert('ID absensi tidak ditemukan!'); window.location='absensi-siswa-x-b-pengajar.php';</script>";
    exit;
}
?>
...
<head>
    ...
    <title>Siskolah - Update Absensi Siswa X-B</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h1 class="h3 text-gray-800 mb-0">Update Absensi Siswa X-B</h1>
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="dashboard-pengajar.php">Home</a></li>
                            <li class="breadcrumb-item"><a href="absensi-siswa-x-b-pengajar.php">Data Absensi Siswa X-B</a></li>
                            <li class="breadcrumb-item active">Tambah Absensi Siswa X-B</li>
                        </ol>
                    </div>
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="proses-update-absensi-siswa-x-b-pengajar.php" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="card-footer text-right">
                                    ...
                                    <a href="absensi-siswa-x-b-pengajar.php" class="btn btn-secondary">
