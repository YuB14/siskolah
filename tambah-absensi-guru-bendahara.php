...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="dashboard-bendahara.html">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="absensi-guru-bendahara.php">Data Absensi Guru</a></li>
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="proses-tambah-absensi-guru-bendahara.php" method="POST">
                            <div class="card-body">
                                <div class="row">
