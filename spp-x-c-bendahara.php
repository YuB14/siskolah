...
$queryKelas = mysqli_query($koneksi, "SELECT id_kelas FROM kelas WHERE nama_kelas = 'X-C'");
...
<head>
    ...
    <title>Siskolah - SPP Kelas X-C</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <!-- Judul Halaman -->
                        <h1 class="h3 text-gray-800 mb-0">SPP Kelas X-C</h1>

                        <!-- Breadcrumb -->
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="dashboard-bendahara.php">Home</a></li>
                            <li class="breadcrumb-item active">Data SPP Kelas X-C</li>
                        </ol>
                    </div>
                    ...
                    showAlert('added', 'Data SPP kelas X-C berhasil ditambah!');
                    showAlert('updated', 'Data SPP kelas X-C diupdate!');
                    showAlert('deleted', 'Data SPP kelas X-C dihapus!');
                    ?>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            <!-- Judul Card -->
                            <h6 class="m-0 font-weight-bold text-primary">Tabel Data SPP Kelas X-C</h6>
                            
                        </div>
                        <div class="card-body">

                            <form method="POST" action="proses-spp-x-c-bendahara.php">
