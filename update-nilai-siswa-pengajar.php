...
if (!isset($_GET['id_nilai'])) {
    echo "<script>
            ...
            window.location.href = 'nilai-siswa.php';
          </script>";
    exit;
}
...
// Ambil data nilai siswa berdasarkan id_nilai
$query = mysqli_query($koneksi, "
    SELECT ns.*, s.nama_lengkap, k.nama_kelas, m.nama_mapel
    FROM nilai_siswa ns
    LEFT JOIN siswa s ON ns.nisn = s.nisn
    LEFT JOIN kelas k ON ns.id_kelas = k.id_kelas
    LEFT JOIN mata_pelajaran m ON ns.id_mapel = m.id_mapel
    WHERE ns.id_nilai = '$id_nilai'
");
...
<head>
    ...
    <title>Siskolah - Update Nilai Siswa</title>
...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h1 class="h3 text-gray-800 mb-0">Update Nilai Siswa</h1>
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="dashboard-pengajar.php">Home</a></li>
                            <li class="breadcrumb-item"><a href="nilai-siswa-pengajar.php">Data Nilai Siswa</a></li>
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Form Update Nilai</h3>
                        </div>
                        <form action="proses-update-nilai-siswa-pengajar.php" method="POST">
                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="id_nilai" value="<?php echo htmlspecialchars($data['id_nilai']); ?>" class="form-control" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-search-container">
                                                        ...
                                                        <input type="hidden" name="nisn" id="selectedNisn" value="<?php echo htmlspecialchars($data['nisn']); ?>" required>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" name="id_kelas" id="selectedIdKelas" value="<?php echo htmlspecialchars($data['id_kelas']); ?>" required>
                                                    <input type="text" class="form-control" id="exampleInputName" value="<?php echo htmlspecialchars($data['nama_kelas']); ?>" readonly>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card mb-3">
                                            ...
                                            <div class="card-body">
                                                ...
                                                foreach ($tugas as $name => $label) {
                                                    $value = isset($data[$name]) ? intval($data[$name]) : '';
                                                    echo "
                                                    <div class='form-group'>
                                                        <label class='font-weight-bold'>$label</label>
                                                        <input type='number' name='$name' class='form-control' placeholder='0-100' min='0' max='100' value='$value'>
                                                    </div>";
                                                }
                                                ?>
                                            </div>
                                        ...
                                        <div class="card mb-3">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="nilai_uts" class="form-control" placeholder="0-100" min="0" max="100" value="<?php echo isset($data['nilai_uts']) ? intval($data['nilai_uts']) : ''; ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label class="font-weight-bold">Nilai UAS</label>
                                                    <input type="number" name="nilai_uas" class="form-control" placeholder="0-100" min="0" max="100" value="<?php echo isset($data['nilai_uas']) ? intval($data['nilai_uas']) : ''; ?>">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <select class="custom-select" name="semester" required>
                                                        ...
                                                        <option value="1" <?php echo ($data['semester'] == '1') ? 'selected' : ''; ?>>Semester 1 (Ganjil)</option>
                                                        <option value="2" <?php echo ($data['semester'] == '2') ? 'selected' : ''; ?>>Semester 2 (Genap)</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="tahun_ajaran" class="custom-select" required>
                                                        ...
                                                        for ($i = 0; $i < $jumlah; $i++) {
                                                            ...
                                                            $next = $th + 1;
                                                            $tahun = "$th/$next";
                                                            $selected = ($tahun == $data['tahun_ajaran']) ? 'selected' : '';
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save"></i> Update Data Nilai
                                </button>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const selectedIdKelas = document.getElementById('selectedIdKelas');
        const kelasInput = document.getElementById('exampleInputName');
        ...
        siswaSelect.querySelectorAll('.siswa-option').forEach(option => {
            option.addEventListener('click', function() {
                ...
                selectedIdKelas.value = idKelas;
                kelasInput.value = namaKelas;
